...
def style_transfer(vgg, decoder, content, style, cont_seg, styl_seg, device, alpha=1.0,
...
for content_path in content_paths:
    if do_interpolation:  # one content image, N style image
        ...
        for style_path in style_paths:
            ...
            with torch.no_grad():
                output = style_transfer(vgg, decoder, content, style, cont_seg, styl_seg, device,
                                        args.alpha)
            output = output.cpu()
